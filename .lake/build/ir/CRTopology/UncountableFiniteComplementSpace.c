...
// Module: CRTopology.UncountableFiniteComplementSpace
...
LEAN_EXPORT lean_object* initialize_CRTopology_UncountableFiniteComplementSpace(uint8_t builtin, lean_object* w) {
lean_object * res;
